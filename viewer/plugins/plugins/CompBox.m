...
if nargin == 0  % LAUNCH GUI
    ...
    handles.text1 = uicontrol(handles.figure1,'Style', 'text', 'Tag', 'text1', ...
        'Units','pixels', 'String', 'Shift X', 'BackgroundColor', [0.5, 0.5, 0.5], 'FontSize', 13);
    handles.text4 = uicontrol(handles.figure1,'Style', 'text', 'Tag', 'text4', ...
        'Units','pixels', 'String', 'Shift Y', 'BackgroundColor', [0.5, 0.5, 0.5], 'FontSize', 13);
    ...
    handles.text2 = uicontrol(handles.figure1,'Style', 'text', 'Tag', 'text2', ...
        'Units','pixels', 'String', 'Zoom X', 'BackgroundColor', [0.5, 0.5, 0.5], 'FontSize', 11);
    handles.text3 = uicontrol(handles.figure1,'Style', 'text', 'Tag', 'text3', ...
        'Units','pixels', 'String', 'Zoom Y', 'BackgroundColor', [0.5, 0.5, 0.5], 'FontSize', 11);
